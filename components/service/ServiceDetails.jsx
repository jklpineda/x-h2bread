                  ...
                  <div className="col-lg-5">
                    <div className="content">
                      ...
                      <p className="mt-2 mb-2">
                        There are many H2Bread h variations of passages of Lorem
                        Ipsum available,
                      </p>
                      <p>
                        H2Bread h variations of be passages of Lorem Ipsum
                        available,
                      </p>
                    </div>
                ...
                <div className="row g-4 mt-2">
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    <div className="service-details-box">
                      ...
                      <p>
                        There are many H2Bread a variations of passages of Lorem
                        Ipsum
                      </p>
                    </div>
                  </div>
